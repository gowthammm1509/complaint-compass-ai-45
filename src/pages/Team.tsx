  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1 dark:text-gray-400">Manage your support team and track performance</p>
      </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b dark:border-gray-700">
                  ...
                  <th className="px-4 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-300">Assigned</th>
                  <th className="px-4 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-300">Resolved</th>
                  <th className="px-4 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-300">Avg. Response</th>
                </tr>
              </thead>
              <tbody>
                {teamMembers.map((member) => (
                  <tr key={member.id} className="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 team-row">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg shadow-sm p-5 border border-gray-100 stat-card">
          <div className="flex justify-between items-start">
            ...
            <div className="p-3 rounded-full bg-blue-50 text-primary icon-container">
